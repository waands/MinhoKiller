...
public class PlayerController : MonoBehaviour
{
    ...
    private bool isShooting = false; // Para rastrear se o botão do mouse esquerdo está pressionado
    ...
    private void AimAndShoot()
    {
        ...
        Vector3 crosshairDirection = (mousePosition - transform.position).normalized;
        ...
        topAnimator.SetBool("Aim", isShooting);
